...
class TestTask4(unittest.TestCase):
    ...
    def test_push__2(self):
        ...
        stack.push(1)
        stack.push(2)
        self.assertEqual(stack.stack, [2, 1, 0])
    ...
    def test_push__4(self):
        ...
        stack.push(2)
        stack.pop()
        self.assertEqual(stack.stack, [1, 0])
    ...
    def test_peak__1(self):
        ...
        stack.push(1)
        stack.push(2)
        self.assertEqual((stack.peek(), stack.stack), (2, [2, 1, 0]))
    ...
    def test_pop__1(self):
        ...
        stack.push(1)
        stack.push(2)
        self.assertEqual((stack.pop(), stack.stack), (2, [1, 0]))
