...
class TestTask6(unittest.TestCase):
    ...
    def test_ispalindrome__1(self):
        self.assertEqual(is_string_palindrome("1221"), True)

    def test_ispalindrome__2(self):
        self.assertEqual(is_string_palindrome(""), True)

    def test_ispalindrome__3(self):
        self.assertEqual(is_string_palindrome("ya gg ay"), True)

    def test_ispalindrome__4(self):
        self.assertEqual(is_string_palindrome("12"), False)

    def test_ispalindrome__5(self):
        self.assertEqual(is_string_palindrome("GOoG"), False)
