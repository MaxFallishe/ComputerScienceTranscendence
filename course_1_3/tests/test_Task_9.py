...
class TestEvenTrees(unittest.TestCase):
    def test_even_trees__1(self):
        """
        In this test, we check how the method works on a tree with such a structure:
                 0
                / \
               1   2
              /    /
        ...
        result = [i.NodeValue for i in result]
        self.assertEqual([0, 1, 2, 4], result)

    def test_even_trees__2(self):
        """
        In this test, we check how the method works on a tree with such a structure:
                   0
                 /   \
        ...
        simple_tree.AddChild(node_2, node_4)
        simple_tree.AddChild(node_4, node_5)
        simple_tree.AddChild(node_4, node_6)
        simple_tree.AddChild(node_1, node_7)
        simple_tree.AddChild(node_1, node_8)
        simple_tree.AddChild(node_4, node_9)

        result = simple_tree.EvenTrees()
        result = [i.NodeValue for i in result]
        self.assertEqual([0, 1, 2, 4], result)

    def test_even_trees__3(self):
        """
        In this test, we check how the method works on a tree with such a structure:
                   0
                 /   \
        ...
        node_11 = SimpleTreeNode(11, None)
        ...
        simple_tree.AddChild(node_1, node_8)
        simple_tree.AddChild(node_4, node_9)
        simple_tree.AddChild(node_2, node_10)
        simple_tree.AddChild(node_10, node_11)

        result = simple_tree.EvenTrees()
        result = [i.NodeValue for i in result]
        self.assertEqual([0, 1, 2, 4, 2, 10], result)
