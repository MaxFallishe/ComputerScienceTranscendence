...
class GraphMocksGeneratorType5(GraphMocksGenerator):
    """
    Сonnected undirected graph object with following structure:
            0 --- 4   6
           / \    | / |
...
class TestWeakVertices(unittest.TestCase):
    def test_weak_vertices__1(self):
        graph_mocks_generator = GraphMocksGeneratorType4()
        graph = graph_mocks_generator.generate_graph()
        result = [i.Value for i in graph.WeakVertices()]
        self.assertEqual(result, [5])

    def test_weak_vertices__2(self):
        graph_mocks_generator = GraphMocksGeneratorType5()
        graph = graph_mocks_generator.generate_graph()
        result = [i.Value for i in graph.WeakVertices()]
        self.assertEqual(result, [4, 8])

    def test_weak_vertices__3(self):
        graph_mocks_generator = GraphMocksGeneratorType3()
        graph = graph_mocks_generator.generate_graph()
        result = [i.Value for i in graph.WeakVertices()]
        self.assertEqual(result, [0, 1, 4, 6, 7])

    def test_weak_vertices__4(self):
        graph_mocks_generator = GraphMocksGeneratorType2()
        graph = graph_mocks_generator.generate_graph()
        result = [i.Value for i in graph.WeakVertices()]
        self.assertEqual(result, [0, 1, 2, 3, 4])

    def test_weak_vertices__5(self):
        graph_mocks_generator = GraphMocksGeneratorType1()
        graph = graph_mocks_generator.generate_graph()
        result = [i.Value for i in graph.WeakVertices()]
        self.assertEqual(result, [0, 1, 2, 3, 4])

    def test_weak_vertices__6(self):
        graph_mocks_generator = GraphMocksGeneratorType0()
        graph = graph_mocks_generator.generate_graph()
        result = [i.Value for i in graph.WeakVertices()]
        self.assertEqual(result, [0, 1, 2])

    def test_weak_vertices__7(self):
        graph_mocks_generator = GraphMocksGeneratorType5()
        graph = graph_mocks_generator.generate_graph()
        graph.WeakVertices()
        result = [i.Value for i in graph.WeakVertices()]
