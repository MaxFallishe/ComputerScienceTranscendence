...
public class OrderedListFourthAdditionTest {

    @Test(expected = IllegalArgumentException.class)
    public void testCompareRawObjectsAsIllegalComparison() {
        OrderedListFourthAddition<Object> orderedList = new OrderedListFourthAddition<>(true);
    ...
    public void testComparePositiveNumbersWithLessthanResult() {
        OrderedListFourthAddition<Number> orderedList = new OrderedListFourthAddition<>(true);
    ...
    public void testCompareStringsWithoutExtraSpacesWithLessthanResult() {
        OrderedListFourthAddition<String> orderedList = new OrderedListFourthAddition<>(true);
    ...
    public void testAddOneValueWithDescOrder() {
        OrderedListFourthAddition<Number> orderedList = new OrderedListFourthAddition<>(false);
    ...
    public void testDeleteWithComplexPatternStringValuesDescOrder() {
        OrderedListFourthAddition<String> orderedList = new OrderedListFourthAddition<>(false);
    ...
    public void testMergeListSameListsWithAscOrder() {
        OrderedListFourthAddition<Number> lst1 = new OrderedListFourthAddition<>(true);
        OrderedListFourthAddition<Number> lst2 = new OrderedListFourthAddition<>(true);
        OrderedListFourthAddition<Number> merger = new OrderedListFourthAddition<>(true);
        ...
        OrderedListFourthAddition<Number> result = merger.mergeList(lst1, lst2);
    ...
    public void testMergeListSameListsWithDescOrder() {
        OrderedListFourthAddition<Number> lst1 = new OrderedListFourthAddition<>(false);
        OrderedListFourthAddition<Number> lst2 = new OrderedListFourthAddition<>(false);
        OrderedListFourthAddition<Number> merger = new OrderedListFourthAddition<>(true);
    ...
    public void testIsSublistFewValuesWithAscOrder() {
        OrderedListFourthAddition<Number> orderedList = new OrderedListFourthAddition<>(true);
        OrderedListFourthAddition<Number> sublist = new OrderedListFourthAddition<>(true);
