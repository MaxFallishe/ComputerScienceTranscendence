...
public class OrderedListFifthAddition<T> {
    public Node<T> head, tail;


    private boolean _ascending;

    public OrderedListFifthAddition(boolean asc) {
        head = null;
        tail = null;
        _ascending = asc;
    }
    ...
    public OrderedListFifthAddition<T> mergeList(OrderedListFifthAddition<T> l1, OrderedListFifthAddition<T> l2) {
        OrderedListFifthAddition<T> resultList = new OrderedListFifthAddition<T>(_ascending);
        if (l1.head == null) {
            return l2;
        }
        if (l2.head == null) {
    ...
    public boolean isSublist(OrderedListFifthAddition<T> l1) {
        Node<T> pointer1 = (l1._ascending) ? l1.head : l1.tail;
